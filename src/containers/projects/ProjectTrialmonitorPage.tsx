  ...
  return (
    <section className="trialmonitor-page">
      ...
      <p className="intro">A personal project to receive alerts when clinical trials are updated on clinicaltrials.gov.</p>
        ...
        <h2>Workflows</h2>
        <p>This project is still work in progress, but the following is implemented:</p>
        <ul>
          <li>A DynamoDB table holds a list of clinical trials to monitor</li>
          <li>
            An AWS Step Functions workflow is periodically executed to check for updated trials:
            <ul>
              <li>
          ...
          <li>A separate Step Functions periodically checks for newly added trials, using search keywords stored in another DynamoDB table.</li>
        </ul>
        ...
        <h2>Frontend</h2>
        <p>
          A frontend website is available at <a href="https://trialsmonitor.com" target="_blank" rel="noopener noreferrer">trialsmonitor.com</a> (not publicly accessible for now).<br/>
          The website is written in Angular + TypeScript, and uses AWS Amplify for deployment. Amplify is also used for user authentication, which is backed by an AWS Cognito User Pool
        </p>
        ...
        <ul>
          <li><a href="https://angular.io" target="_blank" rel="noopener noreferrer">Angular (v9.x)</a> + <a href="https://www.typescriptlang.org" target="_blank" rel="noopener noreferrer">TypeScript</a></li>
          <li>Deployment + authentication: <a href="https://aws.amazon.com/amplify/" target="_blank" rel="noopener noreferrer">AWS Amplify</a></li>
          <li>Authentication: <a href="https://aws.amazon.com/cognito/" target="_blank" rel="noopener noreferrer">AWS Cognito</a></li>
          <li>Hosting: <a href="https://aws.amazon.com/s3/" target="_blank" rel="noopener noreferrer">AWS S3</a> + <a href="https://aws.amazon.com/cloudfront/" target="_blank" rel="noopener noreferrer">AWS CloudFront</a></li>
        </ul>
    </section>
  );
}
